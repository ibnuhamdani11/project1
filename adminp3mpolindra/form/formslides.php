             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Forms Slides <small>upload images disini!</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="../db/addslides.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Upload Slides</label>
                                            <input type="file" name="img">
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Slides</label>
                                            <input class="form-control" name="nameslid" placeholder="nama slides">
                                        </div>
                                        <div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(@$_GET['search']=='cari'){
                                        $hasil = mysql_query("SELECT * FROM slides where id like '%$_POST[search]%'");
                                           $no = 1;
                                               ...
                                               echo "
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href='../db/hapusslides.php?id=$row[id]' onClick=\"return confirm('Apakah Anda yakin akan menghapus $row[nameslid]??')\">Hapus</a>
                                                    </td>
                                                </tr>";
                                      ...
                                      <?php
                                        error_reporting(0);
                                        $hasil = mysql_query("SELECT * FROM slides order by id DESC");

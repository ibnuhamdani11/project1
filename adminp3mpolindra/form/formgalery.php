             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Forms Galery <small>upload photo disini!</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="../db/addgalery.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nameph" placeholder="nama photo">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="15" name="des"></textarea>
                                        </div>
                                        <div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(@$_GET['search']=='cari'){
                                        $hasil = mysql_query("SELECT * FROM galery where id like '%$_POST[search]%'");
                                           $no = 1;
                                               ...
                                               echo "
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href='../db/hapusgalery.php?id=$row[id]' onClick=\"return confirm('Apakah Anda yakin akan menghapus $row[nameph]??')\">Hapus</a>
                                                    </td>
                                                </tr>";
                                      ...
                                      <?php
                                        error_reporting(0);
                                        $hasil = mysql_query("SELECT * FROM galery order by id DESC");

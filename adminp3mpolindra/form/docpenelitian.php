			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Tabel penelitian <small>data upload penelitian</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                                               ...
                                               $no = 1;
                                                   ...
                                                   echo "
                                                    <tr>
                                                        ...
                                                        <td>$row[pesan]</td>
                                                        <td>
                                                            <a href='../db/hapuspenelitian.php?id=$row[id]' onClick=\"return confirm('Apakah Anda yakin akan menghapus $row[judul]??')\">Hapus</a>
                                                        </td>
                                                    </tr>";

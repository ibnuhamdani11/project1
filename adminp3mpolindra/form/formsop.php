                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="../db/addsop.php" enctype="multipart/form-data">
                        ...
                        <div class="panel-heading">
                             Tabel Document Oprasional Standart
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(@$_GET['search']=='cari'){
                                        $hasil = mysql_query("SELECT * FROM docsop where id like '%$_POST[search]%'");
                                           $no = 1;
                                               ...
                                               echo "
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href='../db/hapussop.php?id=$row[id]' onClick=\"return confirm('Apakah Anda yakin akan menghapus $row[namedoc]??')\">Hapus</a>
                                                    </td>
                                                </tr>";
                                      ...
                                      <?php
                                        error_reporting(0);
                                        $hasil = mysql_query("SELECT * FROM docsop order by id DESC");

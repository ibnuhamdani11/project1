	...
	<div class="fix wrap content_wrapper"> <!--fix wrap content_wrapper-->
				<div class="fix content"> <!--fix content-->
					<div class="fix main_content floatleft"><!--fix maint_content floatleft-->
						...
						include("user/indo.php");
							$berita=mysql_query("select * from berita order by id DESC limit $posisi,$batas");
							while($data=mysql_fetch_array($berita)){
						?>
						<div class="fix single_content floatleft" >
							<img style="height:210px; width:623px;" src="img/<?php echo $data['upgam'];?>" />
							<div class="fix single_content_info">
								<h1><b><?php echo $data['jberita']; ?></b></h1>
								<p class="author">Upload by : <?php echo $data['upby']; ?></p>
								<p><?php echo substr($data['cberita'],0,50); ?><a style="font-style:italic;" href="user/moreberita.php?id=<?=$data['id'];?>">...[read more]</a></p>

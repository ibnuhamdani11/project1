				...
				<div class="fix content"> <!--fix content-->
					<div class="fix main_content floatleft"><!--fix maint_content floatleft-->
						<div class="single_page_content fix"><!--single_page_content fix-->
							...
							<h2 style="margin-bottom:15px;">Download Document Oprasional Standart</h2>
							</div>
								...
								$posisi = ( $pg - 1 ) * $batas;
									...
									$document=mysql_query("select * from docsop order by id DESC limit $posisi,$batas");
									while($data=mysql_fetch_array($document)){
								?>
								<div class="contact_info">
									<a href="#"><p><?php echo $data['sop']; ?></p></a>
								</div>
						...
						<?php
						//hitung jumlah data
						$jml_data = mysql_num_rows(mysql_query("SELECT * FROM docsop"));
						//Jumlah halaman

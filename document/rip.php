				...
				<div class="fix content"> <!--fix content-->
					<div class="fix main_content floatleft"><!--fix maint_content floatleft-->
						<div class="single_page_content fix"><!--single_page_content fix-->
							...
							<h2 style="margin-bottom:15px;">Download Document RIP</h2>
							</div>
								<?php
								$batas = 8;
								...
								$posisi = ( $pg - 1 ) * $batas;
									...
									$document=mysql_query("select * from docrip order by id DESC limit $posisi,$batas");
									while($data=mysql_fetch_array($document)){
								?>
								<div class="contact_info">
									<a href="#"><p><?php echo $data['rip']; ?></p></a>
								</div>
						...
						<?php
						//hitung jumlah data
						$jml_data = mysql_num_rows(mysql_query("SELECT * FROM docrip"));
						//Jumlah halaman
